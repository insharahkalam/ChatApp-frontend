  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#ECE5DD]">
      ...
      <div className="bg-[#075E54] pt-14 pb-20 px-6 flex flex-col items-center">
        ...
        <h2 className="text-white text-2xl font-semibold">WhatsApp</h2>
        <p className="text-[#B4E3D8] text-sm mt-1">Simple. Secure. Reliable messaging.</p>
      </div>
      ...
      <div className="flex-1 flex justify-center px-4 -mt-10">
        ...
        >
          ...
          <p className="text-center text-sm text-gray-600">
            No account?{" "}
            <Link to="/register" className="text-[#075E54] font-medium">
              Register
            </Link>
          </p>
        </form>
